...
mvn package -Pdist,native -Drequire.zstd -Drequire.openssl -Dopenssl.prefix="$OPENSSL_ROOT_DIR/1.1.1q" -DskipTests -Dmaven.javadoc.skip=true -Dtar --no-transfer-progress
cd ..

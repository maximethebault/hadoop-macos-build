...
-Drequire.zstd -Dzstd.prefix="$(brew --prefix zstd)" -Dzstd.lib="$(brew --prefix zstd)/lib" -Dbundle.zstd \
-Drequire.snappy -Dsnappy.prefix="$(brew --prefix snappy)" -Dsnappy.lib="$(brew --prefix snappy)/lib" -Dbundle.snappy \
